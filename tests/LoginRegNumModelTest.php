...
class LoginRegNumModelTest extends PHPUnit\Framework\TestCase
{
    ...
    public function testLoginRegNumFind()
    {
    ...
    public function testLoginRegNumCreate()
    {
        $regNum = new Model\LoginRegNum;
        
        $regNum->account_id = 1;
        $regNum->key = '#RAGNAROKAPI';
        $regNum->index = 0;
        $regNum->value = 1000;
